...
<div class="min-w-[320px] flex items-center w-full h-[600px] md:h-screen md:p-20 p-5 bg-[url('../images/login-bg.jpg')] bg-cover bg-center ">
            <div class="w-[440px] max-w-full">
                <h1 class=" text-4xl leading-[2.813rem] tracking-wider  text-white-gray mb-4 font-black">Login Form</h1>
                <h5 class="font-normal text-lg leading-5.5 text-white-gray opacity-70 tracking-wide-2">Login to your account.</h5>
                <form action="login-process.php" method="post">
                    <div class="mt-6">
                        ...
                        <div class="form-wrap">
                            ...
                            <input type="email" class="form-control md:h-14.8" placeholder="Enter your Email" id="email" name="email">
                        </div>
                    </div>
                    <div class="mt-6">
                        ...
                        <div class="form-wrap">
                            ...
                            <input type="password" class="form-control md:h-14.8" placeholder="Enter your Password" id="user-password" name="password">
                        </div>
                    </div>
                    <button class=" mt-8 w-full bg-[#0B646B] rounded-2xl h-14.8 text-xl leading-6.1 tracking-wide-3 uppercase text-sparking transition-all duration-500 hover:bg-[#08464b] hover:text-gray-400" type="submit">Login</button>
                </form>
                <div class="link-wrap mt-8 border-t-[0.75px] border-separator border-solid rotate-[-0.13deg] flex items-center justify-center pt-6">
                    ...
                    <a href="index.php" class="ml-2 text-base tracking-wide-1 underline uppercase text-[#FFFFFF] bg-transparent font-bold">Register</a>
                </div>
                <p class="text-green-200 mt-3">Hint: use user email 'user@example.com' and password 'password'</p>
            </div>
        </div>
</body>
</html>